...
const StemCap:React.FC<Stem> = ({ stemFill }) => {
    return (
        <svg width="31" height="47" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.1 13.32H3.4a1.4 1.4 0 00-1.4 1.4v3.08a.2.2 0 01-.2.2H.9a.4.4 0 00-.4.4v17.7c0 .22.18.4.4.4h.9c.11 0 .2.09.2.2v.55a.7.7 0 00.7.7H5.1a1.5 1.5 0 001.5-1.5V27a.5.5 0 01.5-.5H09a1 1 0 011 1v18a1.5 1.5 0 001.5 1.5h7.04a1.5 1.5 0 001.5-1.5v-18a1 1 0 011-1h2.26a.5.5 0 01.5.5v9.45a1.5 1.5 0 001.5 1.5h2.13a.7.7 0 00.7-.7v-.75h1.1a.4.4 0 00.4-.4V18.4a.4.4 0 00-.4-.4h-1.097v-3.28a1.4 1.4 0 00-1.4-1.4h-3.825a.3.3 0 01-.3-.3V1.056A.657.657 0 0021.952.4h-4.775a.29.29 0 01-.275-.2.29.29 0 00-.275-.2H13.41a.292.292 0 00-.278.2c-.04.12-.151.2-.277.2H8.147a.747.747 0 00-.747.747V13.02a.3.3 0 01-.3.3z" fill="#404040" />
            <path d="M7.1 13.32H3.4a1.4 1.4 0 00-1.4 1.4v3.08a.2.2 0 01-.2.2H.9a.4.4 0 00-.4.4v17.7c0 .22.18.4.4.4h.9c.11 0 .2.09.2.2v.55a.7.7 0 00.7.7H5.1a1.5 1.5 0 001.5-1.5V27a.5.5 0 01.5-.5H09a1 1 0 011 1v18a1.5 1.5 0 001.5 1.5h7.04a1.5 1.5 0 001.5-1.5v-18a1 1 0 011-1h2.26a.5.5 0 01.5.5v9.45a1.5 1.5 0 001.5 1.5h2.13a.7.7 0 00.7-.7v-.75h1.1a.4.4 0 00.4-.4V18.4a.4.4 0 00-.4-.4h-1.097v-3.28a1.4 1.4 0 00-1.4-1.4h-3.825a.3.3 0 01-.3-.3V1.056A.657.657 0 0021.952.4h-4.775a.29.29 0 01-.275-.2.29.29 0 00-.275-.2H13.41a.292.292 0 00-.278.2c-.04.12-.151.2-.277.2H8.147a.747.747 0 00-.747.747V13.02a.3.3 0 01-.3.3z" className="switch-stem" fill={stemFill} />
            ...
            <path d="M20.04 45.5v-19H10v19a1.5 1.5 0 001.5 1.5h7.04a1.5 1.5 0 001.5-1.5z" fill="url(#stem_paint4_linear)" />
